...
namespace ManageEmployees.API.Migrations
{
    ...
    [Migration("20230925170601_CreatedTableAndDbContext")]
    partial class CreatedTableAndDbContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ManageEmployees.API.Models.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("EndDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 25, 20, 6, 1, 363, DateTimeKind.Local).AddTicks(7588));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 25, 20, 6, 1, 363, DateTimeKind.Local).AddTicks(7085));
            ...
            modelBuilder.Entity("ManageEmployees.API.Models.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("BirthDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 25, 20, 6, 1, 363, DateTimeKind.Local).AddTicks(3282));
